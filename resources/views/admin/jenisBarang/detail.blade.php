                    ...
                    <div class="card-body">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createJenisBarangModal">Tambah Data</button>
                            </div>
                        </div>
                                                ...
                                                <form method="POST" action="{{ route('JenisBarang.update', $jenis->id_jenis) }}">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="nama_jenis" class="form-control input-default" placeholder="Nama Jenis Barang" value="{{ $jenis->nama_jenis }}">
                                                        </div>
                                                    </div>
...
<div class="modal fade bd-example-modal-lg" id="createJenisBarangModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form method="POST" action="{{ route('JenisBarang.store') }}">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nama Jenis Barang</label>
                        <input type="text" name="nama_jenis" class="form-control input-default" placeholder="Jenis Barang">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
