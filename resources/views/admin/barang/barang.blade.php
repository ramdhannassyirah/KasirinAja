                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#createBarangModal">Tambah Data</button>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm"
                                                        data-toggle="modal"
                                                        data-target="#editUserModal{{ $item->id }}">Edit <i
                                                    ...
                                                    <form id="delete-form-{{ $item->id }}"
                                                        ...
                                                        <button type="button" class="btn btn-danger btn-sm"
                                                            onclick="confirmDelete({{ $item->id }})">Hapus <i
                                                                class="fa fa-trash"></i></button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <div class="modal fade bd-example-modal-lg"
                                                id="editUserModal{{ $item->id }}" tabindex="-1" role="dialog"
                                                aria-hidden="true">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" name="stok"
                                                                        class="form-control input-default"
                                                                        placeholder="Stock" value="{{ $item->stok }}">
                                                                </div>
                                                            </div>
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('barang.store') }}">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nama Barang</label>
                            <input type="text" name="nama_barang" class="form-control input-default"
                                placeholder="Nama Barang">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Harga Barang</label>
                            <input type="number" name="harga" class="form-control input-default"
                                placeholder="Harga Barang">
                        </div>
                        <div class="form-group">
                            <label>Stock</label>
